...
model.add(Convolution2D(nb_filters_1, 9, 9,  activation="relu", input_shape=(28, 28, 1),border_mode='same'))
...
model.add(Convolution2D(nb_filters_2,3,3,activation="relu",border_mode='same'))
model.add(ZeroPadding2D(padding=(1,1)))
