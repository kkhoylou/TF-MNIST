...
model.add(Convolution2D(16, nb_conv, nb_conv,  activation="relu", input_shape=(28, 28, 1),border_mode='valid'))
...
model.add(Convolution2D(32,nb_conv,nb_conv,activation="relu",border_mode='valid'))
