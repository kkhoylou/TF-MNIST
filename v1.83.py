...
#Add a single Convolution Layer with 64 filters
...
model.add(Convolution2D(nb_filters_1,nb_conv,nb_conv,activation="relu",border_mode='valid'))
...
pred_ridge = pd.DataFrame(data=model.predict(test_x),    # values
              			  index= range(1,28000), #Set Index
