...
from keras.layers import Dense, Dropout, Convolution2D, MaxPooling2D, Flatten, Input, ZeroPadding2D
...
model.add(Convolution2D(nb_filters_1, 5, 5,  activation="relu", input_shape=(28, 28, 1),border_mode='valid'))
model.add(ZeroPadding2D(padding=(1,1)))

#Add pooling function
model.add(MaxPooling2D(pool_size=(2,2)))

#Add a second Convolution layer with 128 filters
model.add(Convolution2D(nb_filters_1,3,3,activation="relu",border_mode='valid'))
model.add(ZeroPadding2D(padding=(1,1))
